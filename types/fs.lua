...
---
---WARNING: as of Millennium 2.x this does NOT set `size` or `is_symlink` on the
---entries it returns, despite what fs.Entry says - only fs.list does. Recurse
---with fs.list yourself if you need either of those.
---@param path string Directory path
